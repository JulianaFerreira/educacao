...
times = [time, time1]
events = [event, event1]
labels = ["Curso 1", "Curso 2"]

print("Desvinculação:")
t, p = ttest_ind(time, time1, equal_var=True)
print(p)
...
print("Evasão:")
t, p = ttest_ind(time_evadido, time_evadido1, equal_var=True)
print(p)
...
print("Graduação:")
t, p = ttest_ind(time_graduado, time_graduado1, equal_var=True)
print(p)
